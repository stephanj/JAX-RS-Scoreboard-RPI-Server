...
public class UserServiceTest {
    ...
    public static void start() throws IOException {
        ...
        p.setProperty(EJBContainer.APP_NAME, "scoreboard");
    ...
    public void create() throws NamingException {
        /*
        UserDAO dao = (UserDAO) container.getContext().lookup("java:global/scoreboard-example/UserDAO");
        User user = dao.create("foo", "dummy", "foo@dummy.org");
        assertNotNull(dao.find(user.getId()));

        String uri = "http://127.0.0.1:" + System.getProperty(EmbeddedTomEEContainer.TOMEE_EJBCONTAINER_HTTP_PORT) + "/scoreboard-example";
     ...
     * It allows to use cxf proxy to call remotely our scoreboard service.
